package cn.sleepybear.gaokaorecommendzhiyuan.advice;


import cn.sleepybear.gaokaorecommendzhiyuan.exception.FrontException;
 ...
 * @date 2021/8/10 1:59
 */
@RestControllerAdvice(basePackages = {"cn.sleepybear.gaokaorecommendzhiyuan.controller"})
@Slf4j
